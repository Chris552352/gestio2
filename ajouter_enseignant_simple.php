<?php
/**
 * Script simplifié pour ajouter un enseignant
 */
        ...
        if ($existing_user) {
            ...
            try {
                ...
                if ($result) {
                    ...
                    $message = "Erreur lors de l'ajout de l'enseignant dans la base de données.";
                }
            } catch (Exception $e) {
...
<body>
    <div class="ajout-enseignant-header">
        <img src="Nouveau dossier/7117268-responsable-remarketing-et-specialiste-mettre-des-annonces-ciblees-strategie-de-remarketing-outil-de-marketing-numerique-concept-de-methodologie-de-generation-de-visiteurs-vectoriel.jpg" class="ajout-enseignant-header-img" alt="Décor enseignant">
                ...
                <div class="ajout-enseignant-card shadow">
                    ...
                    <?php if ($login_info): ?>
                        <div class="alert alert-success">
                            ...
                            <p class="mb-0"><small>Veuillez communiquer ces informations à l'enseignant.</small></p>
                        </div>
                    <?php endif; ?>
