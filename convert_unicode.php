<?php
/**
 * Script simple pour convertir les caractères Unicode encodés (\u00xx) en caractères français normaux
 */

// Fonction pour convertir les caractères Unicode encodés en caractères normaux
function convert_unicode_to_normal($content) {
    // Utiliser une expression régulière pour capturer tous les caractères Unicode
...
function process_directory($dir) {
    ...
    foreach ($files as $file) {
        ...
        if (is_dir($path)) {
            ...
            // Vérifier si des modifications ont u00e9té apportées
            if ($content !== $new_content) {
                // Sauvegarder le fichier original
                $backup_path = $path . '.bak';
                file_put_contents($backup_path, $content);
                
                // u00c9crire le contenu modifié
...
if ($modified_count > 0) {
    echo "<h2>Fichiers modifiés</h2>\n    <div class='card'>\n        <div class='card-header'>\n            <h5 class='card-title mb-0'>Liste des fichiers où des caractères Unicode ont u00e9té convertis</h5>\n        </div>\n        <div class='card-body'>\n            <div class='table-responsive'>\n                <table class='table table-striped'>\n                    <thead>\n                        <tr>\n                            <th>Fichier</th>\n                            <th>Statut</th>\n                        </tr>\n                    </thead>\n                    <tbody>";
